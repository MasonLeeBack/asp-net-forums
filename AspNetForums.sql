...
IF NOT EXISTS (SELECT Username FROM Users WHERE Username='Admin')
  INSERT INTO Users (Username, [Password], Email) VALUES ('Admin', 'admin', 'noemail')
...
-- Create a new forum
INSERT INTO Forums VALUES (@ForumGroupIdent, 'Sample Unmoderated Forum', 'A sample unmoderated forum created when the AspNetForums were installed.', GetDate(), 0, 0, 1, 10, 0, 0, 0, 0, null, '')
SET @ForumIdent = @@IDENTITY

-- Create a new post in this forum
exec sp_AddPost @ForumIdent, 0, 'Sample Post in unmoderated forum', 'Admin', 'Sample post in unmoderated forum', 0, null

INSERT INTO Forums VALUES (@ForumGroupIdent, 'Sample Moderated Forum', 'A sample moderated forum created when the AspNetForums were installed.', GetDate(), 1, 0, 1, 20, 0, 0, 0, 0, null, '')
SET @ForumIdent = @@IDENTITY

-- Create a new post in this forum
exec sp_AddPost @ForumIdent, 0, 'Sample Post in moderated forum', 'Admin', 'Sample post in moderated forum', 0, null

INSERT INTO Forums VALUES (@ForumGroupIdent, 'Sample Private Forum', 'A sample private forum created when the AspNetForums were installed.', GetDate(), 0, 0, 1, 30, 0, 0, 0, 0, null, '')
SET @ForumIdent = @@IDENTITY

-- Create a new post in this forum
exec sp_AddPost @ForumIdent, 0, 'Sample Post in private forum', 'Admin', 'Sample post in private forum', 0, null
