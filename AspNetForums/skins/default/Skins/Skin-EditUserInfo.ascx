...
--%>
    ...
    <span id="RoleBasedSecurity" runat="server" Visible="false">
        <tr>
            <td class="forumHeaderBackgroundAlternate" align="left" height="20"><div class="forumTitle">&nbsp;Role Based Security</div></td>
        </tr>
        <tr>
            <td class="forumRow">
                <table cellSpacing="0" cellPadding="3" border="0" width="100%">
                    <tr>
                        <td><div class="normalTextSmaller">&nbsp;</div></td>
                    </tr>
                    <tr>
                        <td valign="top" width="50%">
                            <div class="normalTextSmallBold">&nbsp;&nbsp; Active Roles:</div><br><br>
                            <asp:DataGrid ID="ActiveRoles" Runat="server" Width="100%" AutoGenerateColumns="False" CssClass="tableBorder">
                                <Columns>
                                    ...
                                    <asp:TemplateColumn
                                        ...
                                        ItemStyle-CssClass="forumRow">
                                        <HeaderTemplate>
                                            <div class="forumTitle">Role</div>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <div class="normalTextSmallBold"><%# Container.DataItem %></div>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                </Columns>
                            </asp:DataGrid>
                        ...
                        <td valign="top" width="50%">
                            <div class="normalTextSmallBold">&nbsp;&nbsp; All Roles:</div><br><br>
    ...
    <span id="Administration" runat="server" Visible="false">
        <TR>
            <td class="forumHeaderBackgroundAlternate" align="left" height="20"><div class="forumTitle">&nbsp;Administrator Options </div></td>
        </TR>
        <tr>
            <td class="forumRow">
                <table cellSpacing="0" cellPadding="3" border="0">
        ...
        <tr>
            <td valign="top" align="center">
                <span runat="server" id="PasswordRequired">
                    <div class="normalTextSmallBold">Password (required for update): </div>
